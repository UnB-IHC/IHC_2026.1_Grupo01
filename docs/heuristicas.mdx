...
[1] NIELSEN, Jakob. **Usability Engineering.** Boston: Academic Press, 1994.

[2] NIELSEN, Jakob. **10 Usability Heuristics for User Interface Design.** Nielsen Norman Group, 1994. Disponível em: https://www.nngroup.com/articles/ten-usability-heuristics/

[3] DINIZ, V.; FERRAZ, R.; NASCIMENTO, C. M.; CREDIDIO, R. **Guia de Boas Práticas para Acessibilidade Digital.** Programa de Cooperação entre Reino Unido e Brasil em Acesso Digital, 2023. Disponível em: https://www.gov.br/governodigital/pt-br/acessibilidade-e-usuario/acessibilidade-digital/guiaboaspraaticasparaacessibilidadedigital.pdf
...
[5] W3C. **Web Content Accessibility Guidelines (WCAG) 2.2 – Candidata a Tradução Autorizada em Português do Brasil.** Disponível em: https://www.w3c.br/traducoes/wcag/wcag22-pt-BR/
